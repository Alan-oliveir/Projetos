...
**Tecnologias:** Python, Streamlit, PRAW (Reddit API), TextBlob, Matplotlib, WordCloud  
**Tags:** `#python`   
...
**Tecnologias:** HTML5, CSS3, JavaScript, SweetAlert  
...
**Tecnologias:** Python, CustomTkinter, SQLite, Pillow, API Via Cep  
...
**Tecnologias:** Python, OpenCV, Pillow, customTkinter  
...
**Tecnologias:** Python, customTkinter, SQLite, Cryptography (Fernet)  
...
**Tecnologias:** C#, .NET MAUI, Android, iOS, Windows  
...
**Tecnologias:** Java, Spring Boot, Spring Data JPA, Bean Validation, Flyway, MySQL  
